...
export const StartMessageThreadAdmin = ({submitFunction, users, cancelFunction, type}) => {
    //no users or type
    ...
    const handleSubmit = async (values, {resetForm}) => {
        ...
        if (res.success) {
            ...
            sendAutoEmail('new_message', {email: res.thread.userEmail, fullName: res.thread.userFullName});
        } else {
