...
export const LocationMiniEditForm = ({ editingKey, recordId, users }) => {
  ...
  return (
    <Form>
        ...
        <StyledError name="name" component="div" /></StyledLabel>
        <StyledLabel>First line of address:
        <StyledInput name="firstLine" disabled={editingKey !== recordId} />
        <StyledError name="firstLine" component="div" /></StyledLabel>
        <StyledLabel>Second line of address:
        <StyledInput name="secondLine" disabled={editingKey !== recordId} />
        <StyledError name="secondLine" component="div" /></StyledLabel>
        <StyledLabel>Postcode:
